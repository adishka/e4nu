...
void AbsXSec_OverlayDeltaPhiT_FigExtData10() {
...
//			205,34,768,768);
		...
		for (int WhichPlot = 0; WhichPlot < NPlots; WhichPlot ++) {
			...
			for (int WhichEnergy = 0; WhichEnergy < NEnergies; WhichEnergy ++) {
				...
				double MaxHeight = 0.5; // In order to use y-axis ticks with common scale, constraint range between (0,MaxHeight)
...
//		PlotCanvas->SaveAs("../../myPlots/pdf/"+xBCut[WhichxBCut]+"/"+version+ext+"DeltaPhiT_FigExtData10"+WhatModelsAreIncluded+"_SuSav2_AbsXSec.pdf");
