...
void AccCorrXSec_OverlayDeltaPhiT_FigExtData8() {
...
//	FSIModel.push_back("hA2018_Final_RadCorr_LFGM_SixSectors");
	...
	for (int WhichxBCut = 0; WhichxBCut < NxBCuts; WhichxBCut ++) {
		...
		for (int WhichPlot = 0; WhichPlot < NPlots; WhichPlot ++) {
			...
			for (int WhichEnergy = 0; WhichEnergy < NEnergies; WhichEnergy ++) {
				...
				for (int WhichNucleus = 0; WhichNucleus < NNuclei; WhichNucleus ++) {
					...
					if (nucleus[WhichNucleus] == "56Fe") { MaxHeight = 23; }
		...
		latexYTitle.DrawLatexNDC(0.6,0.1,"#frac{d#sigma}{d#phi_{T}} #left[#frac{nb}{deg}#right]");
		...
		latexYTitleFe.DrawLatexNDC(0.6,0.05,"#frac{d#sigma}{d#phi_{T}} #left[#frac{nb}{deg}#right]");
