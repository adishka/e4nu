...
//	FSIModel.push_back("hA2018_Final_RadCorr_LFGM_SixSectors");
	...
	NameOfPlots.push_back("DeltaAlphaT_Int_0"); OutputPlotNames.push_back("DeltaAlphaT");
	...
	for (int WhichxBCut = 0; WhichxBCut < NxBCuts; WhichxBCut ++) {
		...
		TFile* fXSecFile = TFile::Open("myXSec/DeltaAlphaT_AccCorr_XSec_"+xBCut[WhichxBCut]+".root","recreate");
